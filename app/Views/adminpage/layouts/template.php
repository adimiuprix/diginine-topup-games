                ...
                <ul>
                    ...
                    <li class="nav-item nav-item-has-children">
                        ...
                        <ul id="ddmenu_2" class="collapse dropdown-nav">
                            ...
                            <li>
                                <a href="<?= base_url('admin/transaction-success'); ?>"> Berhasil </a>
                            </li>
                            <li>
                                <a href="<?= base_url('admin/transaction-failed'); ?>"> Gagal </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="user-manager">
                            ...
                            <span class="text">Member manager</span>
                        </a>
                    </li>
