<div class="section-menu-left">
    ...
    <div class="over-content">
        <div class="content mt-30">
            <h6>Account</h6>
            <ul class="menu-tab">
                <li class="tablinks" data-tabs="dashboard">
                ...
                <li class="tablinks" data-tabs="history-trx">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path
                                fill-rule="evenodd"
                                ...
                                />
                            <path d="M14.668 6.14166C15.6488 6.45883 16.3418 7.33425 16.4252 8.36183" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                    </svg>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <li class="tablinks" data-tabs="history-deposit">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path
                                fill-rule="evenodd"
                            ...
                            <path
                                ...
                                fill="white"
                                />
                            <mask id="mask0_1075_5813" style="mask-type: luminance;" maskUnits="userSpaceOnUse" x="1" y="2" width="20" height="19">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.83398 2.75H20.7527V20.3252H1.83398V2.75Z" fill="white" />
                            </mask>
                ...
                <li class="tablinks" data-tabs="mutation">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path
                                fill-rule="evenodd"
                ...
                <li class="tablinks" data-tabs="withdraw">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path
                                fill-rule="evenodd"
                                ...
                                stroke-linejoin="round"
                                />
                            <ellipse cx="11.1587" cy="10.8983" rx="2.41648" ry="2.41648" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                    </svg>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
