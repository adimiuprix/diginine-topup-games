            ...
            <div class="row flex flex-wrap">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <?php elseif($detailProduct['id_cats'] == 2): ?>
                        ...
                        <?php if($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 21): ?>

                            <!-- Memanggil Modul Magic Chest -->
                            <?= $this->include('partials/jokis/magic-chest.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 22): ?>

                            <!-- Memanggil Modul Joki Rank -->
                            <?= $this->include('partials/jokis/joki-rank.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 23): ?>

                            <!-- Memanggil Modul Komen Album -->
                            <?= $this->include('partials/jokis/coment-album.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 24): ?>

                            <!-- Memanggil Modul Awal Season -->
                            <?= $this->include('partials/jokis/awal-season.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 25): ?>

                            <!-- Memanggil Modul Mabar -->
                            <?= $this->include('partials/jokis/mabar.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 26): ?>

                            <!-- Memanggil Modul Gift Skin -->
                            <?= $this->include('partials/jokis/gift-skin.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 27): ?>

                            <!-- Memanggil Modul Room Tournament -->
                            <?= $this->include('partials/jokis/room-tournament.php'); ?>

                        <?php elseif($detailProduct['id_cats'] == 2 && $detailProduct['id'] == 28): ?>

                            <!-- Memanggil Modul Video Montage -->
                            <?= $this->include('partials/jokis/video-moontage.php'); ?>
                    ...
                    <form action="<?= base_url('confirm-order'); ?>" method="post">
                        ...
                        <input type="hidden" name="service" value="<?= $detailProduct['id']; ?>">
                        <div data-wow-delay="0s" class="wow fadeInRight product-item time-sales animated" style="visibility: visible; animation-delay: 0s; animation-name: fadeInRight;">
                            <h6><i class="icon-clock"></i> Masukkan nomor pengisian</h6>

                            <div class="content">
                                <fieldset>
                                    <input type="number" placeholder="nomor pengisian" name="player" required />
                                </fieldset>
                            </div>
